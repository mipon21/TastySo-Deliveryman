import 'dart:convert';
import 'package:tastyso_delivery_driver/feature/Incentive/screens/incentive_screen.dart';
import 'package:tastyso_delivery_driver/feature/auth/screens/delivery_man_registration_screen.dart';
import 'package:tastyso_delivery_driver/feature/auth/screens/sign_in_screen.dart';
import 'package:tastyso_delivery_driver/feature/notification/domain/models/notification_body_model.dart';
import 'package:tastyso_delivery_driver/feature/chat/domain/models/conversation_model.dart';
import 'package:tastyso_delivery_driver/feature/cash_in_hand/screens/cash_in_hand_screen.dart';
import 'package:tastyso_delivery_driver/feature/cash_in_hand/screens/transaction_history_screen.dart';
import 'package:tastyso_delivery_driver/feature/cash_in_hand/screens/payment_screen.dart';
import 'package:tastyso_delivery_driver/feature/cash_in_hand/screens/payment_successful_screen.dart';
import 'package:tastyso_delivery_driver/feature/chat/screens/chat_screen.dart';
import 'package:tastyso_delivery_driver/feature/chat/screens/conversation_screen.dart';
import 'package:tastyso_delivery_driver/feature/dashboard/screens/dashboard_screen.dart';
import 'package:tastyso_delivery_driver/feature/disbursements/screens/add_withdraw_method_screen.dart';
import 'package:tastyso_delivery_driver/feature/disbursements/screens/disbursement_screen.dart';
import 'package:tastyso_delivery_driver/feature/disbursements/screens/withdraw_method_screen.dart';
import 'package:tastyso_delivery_driver/feature/forgot_password/screens/forgot_password_screen.dart';
import 'package:tastyso_delivery_driver/feature/forgot_password/screens/new_password_screen.dart';
import 'package:tastyso_delivery_driver/feature/forgot_password/screens/verification_screen.dart';
import 'package:tastyso_delivery_driver/feature/html/screens/html_viewer_screen.dart';
import 'package:tastyso_delivery_driver/feature/language/screens/language_screen.dart';
import 'package:tastyso_delivery_driver/feature/notification/screens/notification_screen.dart';
import 'package:tastyso_delivery_driver/feature/order/screens/order_details_screen.dart';
import 'package:tastyso_delivery_driver/feature/order/screens/running_order_screen.dart';
import 'package:tastyso_delivery_driver/feature/profile/screens/update_profile_screen.dart';
import 'package:tastyso_delivery_driver/feature/splash/screens/splash_screen.dart';
import 'package:tastyso_delivery_driver/feature/support/screens/support_screen.dart';
import 'package:tastyso_delivery_driver/feature/update/screens/update_screen.dart';
...
class RouteHelper {
  ...
  static String getOrderDetailsRoute(int? id,
          {bool fromNotification = false}) =>
      '$orderDetails?id=$id&from_notification=${fromNotification.toString()}';
  ...
  static String getWithdrawMethodRoute({bool isFromDashBoard = false}) =>
      '$withdrawMethod?is_from_dashboard=${isFromDashBoard.toString()}';
  ...
  static List<GetPage> routes = [
    ...
    GetPage(
        ...
        page: () {
          ...
          return VerificationScreen(
              number: Get.parameters['number'], firebaseSession: session);
        }),
    GetPage(
        name: main,
    ...
    GetPage(
        ...
        page: () {
          ...
          if (Get.parameters['notification_body'] != 'null') {
            notificationBody = NotificationBodyModel.fromJson(jsonDecode(utf8
    ...
    GetPage(
        name: withdrawMethod,
        page: () => WithdrawMethodScreen(
            isFromDashboard: Get.parameters['is_from_dashboard'] == 'true')),
    GetPage(
        name: addWithdrawMethod, page: () => const AddWithDrawMethodScreen()),
    GetPage(
        name: success,
        page: () => PaymentSuccessfulScreen(
            success: Get.parameters['status'] == 'success')),
    GetPage(
        name: payment,
        page: () {
