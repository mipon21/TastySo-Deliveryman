...
import 'package:tastyso_delivery_driver/feature/chat/widgets/chat_video_view.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<ChatController>(builder: (chatController) {
      ...
      bool canShowSeenIcon = isRightMessage &&
          ...
          currentMessage.filesFullUrl == null;
          ...
          children: [
              ...
              Align(
                ...
                child: Padding(
                  padding: const EdgeInsets.only(
                      bottom: Dimensions.paddingSizeDefault, top: 5),
                  child: Text(
                    chatController.getChatTime(
                        currentMessage.createdAt!, nextMessage?.createdAt),
            ...
            Padding(
              padding: isRightMessage
                  ...
                  : EdgeInsets.fromLTRB(
                      Dimensions.paddingSizeSmall,
                      isSameUserWithNextMessage ? 5 : 10,
                      20,
                      (isSameUserWithNextMessage ||
                                  isSameUserWithPreviousMessage) &&
                              currentMessage.message != null
                                ...
                                children: [
                                  if (currentMessage.message != null)
                                    Flexible(
                                      ...
                                      child: InkWell(
                                        onTap: () {
                                          chatController.toggleOnClickMessage(
                                              currentMessage.id!);
                                        },
                                        child: Text(
                                      ...
                                      children: [
                                        AnimatedContainer(
                                          ...
                                          child: Padding(
                                            ...
                                            child: Text(
                                              chatController.getOnPressChatTime(
                                                      currentMessage) ??
                                                  "",
                                              style: robotoRegular.copyWith(
                                                  fontSize:
                                                      ...
                                                      textDirection: isRightMessage &&
                                                          ...
                                                          : !isLTR &&
                                                              ...
                                                              : TextDirection
                                                                  .ltr,
                                                      child: SizedBox(
                                                        width: _isPdf(currentMessage
                                                                .filesFullUrl![0])
                                                            ? 200
                                                            : 300,
                                                        child: _isVideo(currentMessage
                                                                    .filesFullUrl![
                                                                0])
                                                            ? InkWell(
                                                                onLongPress: () =>
                                                                    chatController.toggleOnClickImageAndFile(
                                                                        currentMessage
                                                                            .id!),
                                                                child: ChatVideoView(
                                                                    url: currentMessage.filesFullUrl![
                                                                        0]))
                                                            : _isPdf(currentMessage.filesFullUrl![
                                                                    0])
                                                                ? PdfViewWidget(
                                                                    currentMessage:
                                                                        currentMessage,
