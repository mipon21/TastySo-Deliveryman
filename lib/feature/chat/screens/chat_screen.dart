...
import 'package:tastyso_delivery_driver/feature/chat/widgets/conversation_details_shimmer_widget.dart';
...
import 'package:tastyso_delivery_driver/feature/chat/widgets/message_bubble_widget.dart';
...
import 'package:tastyso_delivery_driver/common/widgets/paginated_list_view_widget.dart';
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void initState() {
    ...
    Get.find<ChatController>()
      ...
      Get.find<ChatController>().startMessagePolling(
  ...
  void dispose() {
    ...
    Get.find<ChatController>().stopMessagePolling();
    super.dispose();
  }
          ...
          appBar: AppBar(
            ...
            title: Row(children: [
              ...
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                (chatController.messageModel != null &&
                        chatController
                                .messageModel!.conversation!.receiver!.phone !=
                            null)
                    ? Text(
                      ...
                      child: Column(children: [
                        ...
                        (chatController.messageModel != null &&
                            ...
                            ? Container(
                                ...
                                child: Column(children: [
                                  chatController.pickedVideoFile != null
                                      ? Container(
                                          width: 250,
                                      ...
                                      : const SizedBox(),
                                  chatController.objFile.isNotEmpty
                                      ? SizedBox(
                                          height: 70,
                                      ...
                                      : const SizedBox(),
                                  chatController.chatImage!.isNotEmpty
                                      ? SizedBox(
                                          height: 100,
