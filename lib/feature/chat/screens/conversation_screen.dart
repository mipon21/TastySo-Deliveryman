...
import 'package:tastyso_delivery_driver/feature/chat/widgets/search_field_widget.dart';
...
import 'package:tastyso_delivery_driver/common/widgets/custom_ink_well_widget.dart';
        ...
        return Padding(
          ...
          child: Column(children: [
            ...
            Expanded(
              ...
              onRefresh: () async {
                await chatController.getConversationList(1,
                ...
                SliverToBoxAdapter(
                  child: (conversation0 != null &&
                      ...
                      ? conversation0.conversations!.isNotEmpty
                          ? conversationCard(chatController, conversation0)
                          : Padding(
                              padding:
                                  EdgeInsets.only(top: context.height * 0.25),
                              child: Center(
                                  child: Column(
                                children: [
            ...
            child: PaginatedListViewWidget(
              ...
              productView: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  String? hasFile = conversation.lastMessage != null &&
                          conversation.lastMessage!.files != null
                      ? '${conversation.lastMessage?.files?.length} ${'attachment'.tr}'
                      : null;
                          ...
                          await Get.toNamed(RouteHelper.getChatRoute(
                            notificationBody: NotificationBodyModel(
                              ...
                              customerId: type == UserType.customer.name
                                  ? user.userId
                                  : null,
                              vendorId: type == UserType.vendor.name
                                  ? user.vendorId
                                  : null,
                            ),
