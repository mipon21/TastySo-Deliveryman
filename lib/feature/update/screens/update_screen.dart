import 'package:tastyso_delivery_driver/common/widgets/dotted_divider.dart';
          ...
          child: Padding(
            ...
            child:
              ...
              Text(
                isUpdate
                    ? 'update'.tr
                    : splashController.configModel!.maintenanceModeData
                            ?.maintenanceMessageSetup?.maintenanceMessage ??
                        'we_are_cooking_up_something_special'.tr,
              ...
              Text(
                isUpdate
                    ...
                    : splashController.configModel!.maintenanceModeData
                            ?.maintenanceMessageSetup?.messageBody ??
                        'maintenance_mode'.tr,
                              ...
                              children: [
                                    ...
                                    ? InkWell(
                                        onTap: () async {
                                          if (await canLaunchUrlString(
                                              'tel:${splashController.configModel?.phone}')) {
                                            launchUrlString(
                                                'tel:${splashController.configModel?.phone}',
                                                mode: LaunchMode
                                                    .externalApplication);
                                            ...
                                            showCustomSnackBar(
                                                '${'can_not_launch'.tr} ${splashController.configModel?.phone}');
                                          }
                                        },
                                        child: Text(
                                ...
                                splashController
                                    ...
                                    ? InkWell(
                                        onTap: () async {
                                          if (await canLaunchUrlString(
                                              'mailto:${splashController.configModel?.email}')) {
                                            launchUrlString(
                                                'mailto:${splashController.configModel?.email}',
                                                mode: LaunchMode
                                                    .externalApplication);
                                            ...
                                            showCustomSnackBar(
                                                '${'can_not_launch'.tr} ${splashController.configModel?.email}');
                                          }
                                        },
                                        child: Text(
                      ...
                      onPressed: () async {
                        ...
                        if (GetPlatform.isAndroid) {
                          appUrl = splashController
                              .configModel!.appUrlAndroidDeliveryman;
                        } else if (GetPlatform.isIOS) {
                          appUrl = splashController
                              .configModel!.appUrlIosDeliveryman;
                        }
