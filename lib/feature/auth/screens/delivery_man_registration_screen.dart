...
import 'package:tastyso_delivery_driver/feature/auth/widgets/additional_data_section_widget.dart';
import 'package:tastyso_delivery_driver/feature/forgot_password/widgets/pass_view_widget.dart';
import 'package:tastyso_delivery_driver/helper/custom_validator.dart';
...
import 'package:tastyso_delivery_driver/common/widgets/custom_dropdown_widget.dart';
import 'package:tastyso_delivery_driver/common/widgets/custom_text_field_widget.dart';
...
import 'package:tastyso_delivery_driver/feature/auth/domain/models/delivery_man_body_model.dart';
            ...
            child: Container(
              ...
              child: Row(spacing: Dimensions.paddingSizeSmall, children: [
                Expanded(
                  child: Container(
                    height: 4,
                    color: Get.find<AuthController>().dmStatus == 0.4
                ...
                Expanded(
                  child: Container(
                    ...
                    color: Get.find<AuthController>().dmStatus != 0.4
                        ? Theme.of(context).primaryColor.withValues(alpha: 0.5)
                        : Get.find<AuthController>().dmStatus != 0.4
                            ? Theme.of(context).primaryColor
                            : Theme.of(context)
                                .disabledColor
            ...
            return Column(children: [
                              ...
                              CustomCard(
                                ...
                                child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                          'image_format_and_ratio_for_profile'
                                              .tr,
                                          style: robotoRegular.copyWith(
                                              fontSize:
                                  ...
                                  Container(
                                    ...
                                    child: CustomDropdown<int>(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Text(
                                          authController.dmTypeIndex == -1
                                              ? 'select_delivery_type'.tr
                                              : authController
                                                  .dmTypeList[authController
                                                      .dmTypeIndex]!
                                                  .tr,
                                          style: robotoRegular.copyWith(
              ...
              Container(
                ...
                child: CustomButtonWidget(
                  ...
                  buttonText:
                      authController.dmStatus == 0.4 ? 'next'.tr : 'submit'.tr,
                  onPressed: () =>
                      _addDeliveryMan(authController, addressController),
                ),
              ),
            ]);
          });
      ...
      for (Data data in authController.dataList!) {
        ...
        if (isTextField) {
          ...
          if (customFieldEmpty && isRequired) {
            showCustomSnackBar(
                '${'please_set_data_in'.tr} ${authController.camelToSentence(authController.dataList![index].inputData!)} ${'field'.tr}');
            break;
          } else {
          ...
          if (authController.additionalList![index].length == 0 && isRequired) {
            customFieldEmpty = true;
            showCustomSnackBar(
                '${'please_add'.tr} ${authController.camelToSentence(authController.dataList![index].inputData!)}');
            break;
          } else {
      ...
      if (authController.dmTypeIndex == -1) {
        ...
        data.addAll(DeliveryManBodyModel(
          ...
          zoneId: addressController
              ...
              .toString(),
          vehicleId: authController
              .vehicles![authController.vehicleIndex! - 1].id
              .toString(),
        ).toJson());
