...
class AdditionalDataSectionWidget extends StatelessWidget {
  ...
  const AdditionalDataSectionWidget(
      {super.key,
    ...
    return CustomCard(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          bool showTextField =
              authController.dataList![index].fieldType == 'text' ||
                  authController.dataList![index].fieldType == 'number' ||
                  authController.dataList![index].fieldType == 'email' ||
                  authController.dataList![index].fieldType == 'phone';
          bool showDate = authController.dataList![index].fieldType == 'date';
          bool showCheckBox =
              authController.dataList![index].fieldType == 'check_box';
          bool showFile = authController.dataList![index].fieldType == 'file';

          return Padding(
            padding: EdgeInsets.only(
                bottom: index == authController.dataList!.length - 1
                    ? 0
                    : Dimensions.paddingSizeExtraLarge),
            child: showTextField
                ? CustomTextFieldWidget(
                    hintText:
                        authController.dataList![index].placeholderData ?? '',
                    //showLabelText: false,
                    labelText: authController.camelCaseToSentence(
                        authController.dataList![index].inputData ?? ''),
                    controller: authController.additionalList![index],
                    inputType: authController.dataList![index].fieldType ==
                            'number'
                        ? TextInputType.number
                        : authController.dataList![index].fieldType == 'phone'
                            ? TextInputType.phone
                            : authController.dataList![index].fieldType ==
                                    'email'
                ...
                : showDate
                    ? Container(
                        ...
                        child: Row(children: [
                          Expanded(
                              child: Text(
                                  authController.additionalList![index] ??
                                      'not_set_yet'.tr,
                          ...
                          IconButton(
                            onPressed: () async {
                              ...
                              if (pickedDate != null) {
                                ...
                                authController.setAdditionalDate(
                                    index, formattedDate);
                              }
                            },
                    ...
                    : showCheckBox
                        ? Column(
                            ...
                            children: [
                                Row(children: [
                                  Text(
                                      authController.camelCaseToSentence(
                                          authController
