...
class VerificationScreen extends StatefulWidget {
  ...
  const VerificationScreen(
      {super.key, required this.number, this.firebaseSession});
  ...
  String maskPhoneNumber(String phoneNumber) {
    if (phoneNumber.length >= 13) {
      return phoneNumber.replaceRange(
          4, phoneNumber.length - 3, '*' * (phoneNumber.length - 7));
    }
    return phoneNumber;
  }
          ...
          return Column(children: [
                ...
                : Padding(
                    ...
                    child: RichText(
                      ...
                      text: TextSpan(children: [
                        ...
                        TextSpan(
                            text:
                                ' ${'and_your_otp_will_be_expired_within_2min'.tr}',
                            style: robotoRegular.copyWith(
                                color: Theme.of(context).hintColor)),
                      ]),
                    ),
            ...
            Padding(
              padding: EdgeInsets.symmetric(
                  horizontal:
                      context.width > 850 ? 50 : Dimensions.paddingSizeDefault),
            ...
            Padding(
              ...
              child: CustomButtonWidget(
                ...
                fontColor: forgotPasswordController.verificationCode.length == 6
