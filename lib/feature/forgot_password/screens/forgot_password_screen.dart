...
class _ForgotPasswordScreenState extends State<ForgotPasswordScreen> {
  ...
  void initState() {
    super.initState();
    isPhone = (Get.find<SplashController>().configModel!.isSmsActive! ||
              ...
              child: Column(
                  ...
                  children: [
                    const CustomAssetImageWidget(
                        image: Images.forgot, height: 220),
                    Padding(
                      padding: const EdgeInsets.symmetric(
  ...
  void _forgetPass(String countryCode) async {
    ...
    if (phone.isEmpty) {
      ...
      Get.find<ForgotPasswordController>()
          .forgotPassword(numberWithCountryCode)
          .then((status) async {
        if (status.isSuccess) {
          if (Get.find<SplashController>()
            ...
            Get.find<ForgotPasswordController>()
                .firebaseVerifyPhoneNumber(numberWithCountryCode);
          } else {
            Get.toNamed(
                RouteHelper.getVerificationRoute(numberWithCountryCode));
          }
        } else {
