...
import 'package:tastyso_delivery_driver/feature/profile/widgets/profile_bg_widget.dart';
import 'package:tastyso_delivery_driver/feature/profile/widgets/profile_button_widget.dart';
import 'package:tastyso_delivery_driver/feature/profile/widgets/profile_card_widget.dart';
                ...
                mainWidget: SingleChildScrollView(
                    ...
                    child: Center(
                      ...
                      child: Column(children: [
                        ...
                        profileController.profileModel!.shiftName != null
                            ? RichText(
                                ...
                                TextSpan(
                                    text:
                                        ' ${profileController.profileModel!.shiftName}',
                                    style: robotoMedium.copyWith(
                                        color: Theme.of(context).primaryColor,
                                        fontSize: Dimensions.fontSizeSmall)),
                                TextSpan(
                                    text:
                                        ' (${DateConverter.onlyTimeShow(profileController.profileModel!.shiftStartTime!)} - ${DateConverter.onlyTimeShow(profileController.profileModel!.shiftEndTime!)})',
                                    style: robotoMedium.copyWith(
                                        color: Theme.of(context).primaryColor,
                                        fontSize: Dimensions.fontSizeSmall)),
                              ]))
                        ...
                        Row(children: [
                          ProfileCardWidget(
                              ...
                              data:
                                  '${profileController.profileModel!.memberSinceDays} ${'days'.tr}'),
                          const SizedBox(width: Dimensions.paddingSizeSmall),
                          ProfileCardWidget(
                              title: 'total_order'.tr,
                              data: profileController.profileModel!.orderCount
                                  .toString()),
                        ]),
                        const SizedBox(height: 30),
                        ProfileButtonWidget(
                        ...
                        ProfileButtonWidget(
                          ...
                          isButtonActive: profileController.notification,
                          onTap: () {
                        ...
                        InkWell(
                          ...
                          child: DetailsCustomCard(
                            ...
                            child: Row(children: [
                              ...
                              Expanded(
                                  child: Text('background_notification'.tr,
                                      style: robotoRegular)),
                              CupertinoSwitch(
                        ...
                        (profileController.profileModel!.type !=
                            ...
                            ? ProfileButtonWidget(
                                ...
                                title: 'incentive_offers'.tr,
                                onTap: () {
                                  Get.toNamed(RouteHelper.getIncentiveRoute());
                                })
                            : const SizedBox(),
                        SizedBox(
                            height: (profileController.profileModel!.type !=
                                        'restaurant_wise' &&
