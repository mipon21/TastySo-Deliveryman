...
class PaymentInformationDialogWidget extends StatelessWidget {
  ...
  const PaymentInformationDialogWidget({
    super.key,
          ...
          child: Column(children: [
            disbursement.status == 'completed'
                ? Column(children: [
                    ...
                    Text(
                      "you_payment_has_been_completed_your_will_receive_the_amount_within_7_day_please_wait_till_then"
                          .tr,
                  ...
                  children: [
                    ...
                    Row(
                        ...
                        children: [
                          ...
                          Text(disbursement.withdrawMethod!.methodName!,
                              style: robotoBold),
                        ]),
                    const SizedBox(height: Dimensions.paddingSizeDefault),
                    Row(
                    ...
                    Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text('disbursement_id'.tr,
                              style: robotoMedium.copyWith(
                                  fontSize: Dimensions.fontSizeSmall)),
                          Text(disbursement.id.toString(), style: robotoBold),
                        ]),
                    const SizedBox(height: Dimensions.paddingSizeDefault),
                    Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          ...
                          Container(
                            ...
                            child: Text(disbursement.status!.tr,
                                style: robotoMedium.copyWith(
                                    fontSize: Dimensions.fontSizeSmall,
                                    color: Colors.green)),
                          ),
