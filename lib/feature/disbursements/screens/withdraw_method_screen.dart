...
import 'package:tastyso_delivery_driver/feature/disbursements/widgets/confirm_dialog_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:
        ...
        return disbursementController.disbursementMethodBody != null
            ? disbursementController.disbursementMethodBody!.methods!.isNotEmpty
                ? ListView.builder(
                    itemCount: disbursementController
                        .disbursementMethodBody!.methods!.length,
                    shrinkWrap: true,
                    padding:
                        const EdgeInsets.all(Dimensions.paddingSizeDefault),
                    itemBuilder: (context, index) {
                      Methods method = disbursementController
                          .disbursementMethodBody!.methods![index];
                            ...
                            child: Row(
                                ...
                                children: [
                                      ...
                                      itemBuilder: (context, index) {
                                        return Padding(
                                          ...
                                          child: Row(children: [
                                            ...
                                            Expanded(
                                              child: Text(
                                                '${method.methodFields![index].userData}',
                                                style: robotoBold.copyWith(
                                                    fontSize: Dimensions
                                                        .fontSizeDefault),
                                                maxLines: 1,
                                  ...
                                  InkWell(
                                    onTap: () {
                                      Get.dialog(
                                          ConfirmDialogWidget(id: method.id!));
                                    },
                                    child: Padding(
                                      padding: const EdgeInsets.only(
                                          bottom: Dimensions.paddingSizeDefault,
                ...
                : Center(child: Text('no_method_found'.tr, style: robotoMedium))
