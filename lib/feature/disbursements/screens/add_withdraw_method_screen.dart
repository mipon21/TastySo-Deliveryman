...
import 'package:tastyso_delivery_driver/common/widgets/custom_text_form_field.dart';
...
class AddWithDrawMethodScreen extends StatefulWidget {
  ...
  @override
  State<AddWithDrawMethodScreen> createState() =>
      _AddWithDrawMethodScreenState();
}
                      ...
                      Container(
                        ...
                        child: CustomDropdown<int>(
                          ...
                          child: Padding(
                            ...
                            child: Text(
                              disbursementController.widthDrawMethods != null &&
                                      disbursementController
                                          .widthDrawMethods!.isNotEmpty
                                  ? disbursementController
                                      .widthDrawMethods![0].methodName!
                              ...
                              Row(children: [
                                Expanded(
                                  child: CustomTextFormField(
                                    titleName: disbursementController
                                        .methodFields[index].inputName
                                        .toString()
                                        .replaceAll('_', ' '),
                                    hintText: disbursementController
                                        .methodFields[index].placeholder,
                                    controller: disbursementController
                                        .textControllerList[index],
                                    capitalization: TextCapitalization.words,
                                    inputType: disbursementController
                                                .methodFields[index]
                                                .inputType ==
                                            'phone'
                                        ? TextInputType.phone
                                        : disbursementController
                                            ...
                                            : disbursementController
                                                ...
                                                : TextInputType.name,
                                    focusNode:
                                        disbursementController.focusList[index],
                                    nextFocus: index !=
                                            disbursementController
                                                    .methodFields.length -
                                                1
                                        ? disbursementController
                                            .focusList[index + 1]
                                        : null,
                                    isRequired: disbursementController
                                            .methodFields[index].isRequired ==
                                        1,
                                  ),
                                ),
                                disbursementController
                ...
                child: !disbursementController.isLoading
                    ? CustomButtonWidget(
                        ...
                        onPressed: () {
                          ...
                          for (var element
                              in disbursementController.methodFields) {
                            if (element.isRequired == 1) {
                              if (disbursementController
                                  .textControllerList[disbursementController
                                      .methodFields
                                      .indexOf(element)]
                                  .text
                                  .isEmpty) {
                          ...
                          if (fieldEmpty) {
                            ...
                            data['withdraw_method_id'] = disbursementController
                                .widthDrawMethods![
                                    disbursementController.selectedMethodIndex!]
                                .id
                                .toString();
                            for (var result
                                in disbursementController.methodFields) {
                              data[result.inputName] = disbursementController
                                  .textControllerList[disbursementController
                                      .methodFields
                                      .indexOf(result)]
                                  .text
