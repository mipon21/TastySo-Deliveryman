...
import 'package:tastyso_delivery_driver/feature/disbursements/domain/models/disbursement_report_model.dart';
import 'package:tastyso_delivery_driver/feature/disbursements/widgets/disbursement_status_card_widget.dart';
import 'package:tastyso_delivery_driver/feature/disbursements/widgets/payment_information_dialog_widget.dart';
...
class _DisbursementScreenState extends State<DisbursementScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:
          GetBuilder<DisbursementController>(builder: (disbursementController) {
        return disbursementController.disbursementReportModel != null
                ...
                child: Column(
                    ...
                    children: [
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Row(children: [
                            DisbursementStatusCardWidget(
                              amount: disbursementController
                                  .disbursementReportModel!.pending!,
                              text: 'pending_disbursements'.tr,
                              isPending: true,
                            ),
                            DisbursementStatusCardWidget(
                              amount: disbursementController
                                  .disbursementReportModel!.completed!,
                              text: 'completed_disbursements'.tr,
                              isCompleted: true,
                            ),
                            DisbursementStatusCardWidget(
                              amount: disbursementController
                                  .disbursementReportModel!.canceled!,
                      ...
                      (disbursementController
                                      .disbursementReportModel!.disbursements !=
                                  null &&
                              disbursementController.disbursementReportModel!
                                  .disbursements!.isNotEmpty)
                          ? ListView.builder(
                              padding: const EdgeInsets.symmetric(
                                  horizontal: Dimensions.paddingSizeDefault,
                              ...
                              itemCount: disbursementController
                                  ...
                                  InkWell(
                                          ...
                                          return Dialog(
                                            ...
                                            shape: RoundedRectangleBorder(
                                                borderRadius: BorderRadius
                                                    .circular(Dimensions
                                                        .radiusDefault)), //this right here
                                            child:
                                                PaymentInformationDialogWidget(
                                    ...
                                    child: ListTile(
                                      ...
                                      title: Text(
                                          ...
                                          style: robotoMedium),
                                      subtitle: Text(
                                          disbursement.withdrawMethod != null
                                              ? '${"payment_method".tr} : ${disbursement.withdrawMethod!.methodName}'
                                              : 'payment_method_deleted'.tr,
                          ...
                          : Padding(
                              ...
                              child: Center(
                                  child: Text('no_history_available'.tr,
                                      style: robotoMedium))),
                    ]),
              )
