    ...
    return Scaffold(
      ...
      body: GetBuilder<ProfileController>(builder: (profileController) {
        for (var incentive in profileController.profileModel!.incentiveList!) {
          if (incentive.earning! <
              profileController.profileModel!.todaysEarning!) {
            selectedIndex = profileController.profileModel!.incentiveList!
                .indexOf(incentive);
          }
        }
        ...
        return SingleChildScrollView(
          ...
          child:
            ...
            profileController.profileModel!.incentiveList!.isNotEmpty
                ? ListView.builder(
                    shrinkWrap: true,
                    itemCount:
                        profileController.profileModel!.incentiveList!.length,
                                  ...
                                  Text(
                                      PriceConverter.convertPrice(
                                          profileController.profileModel!
                                              .incentiveList![index].earning),
                                      style: robotoMedium),
                                  Text(
                                      PriceConverter.convertPrice(
                                          profileController.profileModel!
                                              .incentiveList![index].incentive),
                                      style: robotoMedium),
                                ]),
                          ]),
                        ),
