class PaginatedOrderModel {
  ...
  PaginatedOrderModel({this.totalSize, this.limit, this.offset, this.orders, this.orderCount});
  ...
  PaginatedOrderModel.fromJson(Map<String, dynamic> json) {
    ...
    orderCount = json['order_count'] != null ? OrderCount.fromJson(json['order_count']) : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (orderCount != null) {
      data['order_count'] = orderCount!.toJson();
    }
    return data;
  }
}
