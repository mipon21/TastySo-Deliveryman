...
import 'package:tastyso_delivery_driver/feature/order/widgets/location_card_widget.dart';
  ...
  void _setMarker(OrderModel orderModel) async {
    try {
      Uint8List restaurantImageData =
          await _convertAssetToUnit8List(Images.restaurantMarker, width: 100);
      Uint8List deliveryBoyImageData =
          await _convertAssetToUnit8List(Images.yourMarker, width: 100);
      Uint8List destinationImageData =
          await _convertAssetToUnit8List(Images.customerMarker, width: 100);
      ...
      if (orderModel.restaurantLat != null &&
          orderModel.restaurantLng != null) {
        _markers.add(Marker(
