...
import 'package:tastyso_delivery_driver/common/widgets/custom_tool_tip_widget.dart';
...
import 'package:tastyso_delivery_driver/feature/order/widgets/divider_widget.dart';
import 'package:tastyso_delivery_driver/feature/order/widgets/order_details_shimmer.dart';
...
import 'package:tastyso_delivery_driver/feature/order/widgets/verify_delivery_sheet_widget.dart';
...
import 'package:tastyso_delivery_driver/helper/responsive_helper.dart';
import 'package:tastyso_delivery_driver/helper/route_helper.dart';
import 'package:tastyso_delivery_driver/helper/string_extensions.dart';
...
class _OrderDetailsScreenState extends State<OrderDetailsScreen> {
  ...
  Future<void> _loadData() async {
    ...
    if (widget.orderIndex == null) {
      ...
      for (int index = 0;
          index < Get.find<OrderController>().currentOrderList!.length;
          index++) {
        if (Get.find<OrderController>().currentOrderList![index].id ==
            widget.orderId) {
          orderPosition = index;
          break;
        }
                        ...
                        child: Column(children: [
                          DateConverter.isBeforeTime(
                              ...
                              ? (controllerOrderModel.orderStatus !=
                                  ...
                                  : const SizedBox()
                              : const SizedBox(),
                          controllerOrderModel.bringChangeAmount != null &&
                                  controllerOrderModel.bringChangeAmount! > 0
                              ? Container(
                                  ...
                                  child: RichText(
                                    text: TextSpan(children: [
                                      ...
                                      TextSpan(
                                          text:
                                              ' ${PriceConverter.convertPrice(controllerOrderModel.bringChangeAmount)}',
                                          style: robotoMedium.copyWith(
                                              color: Theme.of(context)
                                                  .textTheme
                                                  .bodyLarge
                              ...
                              : const SizedBox(),
                          DividerWidget(
                              height: controllerOrderModel.bringChangeAmount !=
                                          null &&
                                      controllerOrderModel.bringChangeAmount! >
                                          0
                                  ? Dimensions.paddingSizeSmall
                                  : 0),
                          InfoCardWidget(
                          ...
                          InfoCardWidget(
                            ...
                            addressModel: DeliveryAddress(
                                address:
                                    controllerOrderModel.restaurantAddress),
                            image:
                                '${controllerOrderModel.restaurantLogoFullUrl}',
                          ...
                          (controllerOrderModel.cutlery != null)
                              ...
                              : const SizedBox(),
                          DividerWidget(
                              height: (controllerOrderModel.cutlery != null)
                                  ? Dimensions.paddingSizeSmall
                                  : 0),
                          ...
                          (controllerOrderModel.orderNote != null &&
                              ...
                              : const SizedBox(),
                          DividerWidget(
                              height: (controllerOrderModel.orderNote != null &&
                                      controllerOrderModel
                          ...
                          (controllerOrderModel.orderStatus == 'delivered' &&
                              ...
                              : const SizedBox(),
                          DividerWidget(
                              height: (controllerOrderModel.orderStatus ==
                                          'delivered' &&
                                      controllerOrderModel.orderProofFullUrl !=
                                          null &&
                                      controllerOrderModel
                              ...
                              child: Column(
                                  ...
                                  children: [
                                    Row(children: [
                                      ...
                                      CustomToolTip(
                                        message:
                                            'completed_after_delivery_picture'
                                                .tr,
                                        ...
                                        ? Container(
                                            ...
                                            child: Column(children: [
                                              ...
                                              Text(
                                                controllerOrderModel.orderStatus ==
                                                        'processing'
                                                    ? 'when_it_is_ready_you_will_be_notified'
                                                        .tr
                                                    : 'when_it_is_ready_for_cooking_you_will_be_notified'
                                                        .tr,
                                                style: robotoRegular.copyWith(
                                                    color: Theme.of(context)
                                                        .hintColor),
                                                              ...
                                                              orderController
                                                                ...
                                                                if (success) {
                                                                  ...
                                                                  Get.find<
                                                                      ...
                                                                      .getCurrentOrders(
                                                                          status:
                                                                              Get.find<OrderController>().selectedRunningOrderStatus!);
                                                                }
                                                              });
                                                            },
                                                          ),
                                                    ...
                                                    child: Column(
                                                        ...
                                                        children: [
                                                          Row(children: [
                                                            ...
                                                            Spacer(),
                                                            Text(
                                                              PriceConverter.convertPrice(order
                                                                              .paymentMethod ==
                                                                          'partial_payment' &&
                                                                      ...
                                                                      orderController
                                                                        ...
                                                                        if (success) {
                                                                          Get.find<ProfileController>()
                                                                              .getProfile();
                                                                          Get.find<OrderController>()
                                                                              .getCurrentOrders(status: Get.find<OrderController>().selectedRunningOrderStatus!);
                                                                        }
                                                                      });
                                                                    },
                                                                  ),
                                                                  ...
                                                                  if (Get.find<
                                                                    ...
                                                                    if (Get.find<
                                                                      ...
                                                                      Get.bottomSheet(
                                                                              ...
                                                                              isScrollControlled: true)
                                                                          .then((isSuccess) {
                                                                        if (isSuccess && controllerOrderModel.paymentMethod == 'cash_on_delivery' ||
                                                                            (order.paymentMethod == 'partial_payment' &&
                                                                      ...
                                                                      Get.bottomSheet(
                                                                          CollectMoneyDeliverySheetWidget(
                                                                            ...
                                                                            orderAmount: order.paymentMethod == 'partial_payment'
                                                                                ? order.payments![1].amount!.toDouble()
                                                                                : controllerOrderModel.orderAmount,
                                                                            cod:
                                                                                controllerOrderModel.paymentMethod == 'cash_on_delivery' || (order.paymentMethod == 'partial_payment' && order.payments![1].paymentMethod == 'cash_on_delivery'),
                                                                          ),
                                                                          isScrollControlled: true);
                                                                    }
                                                                  }
