        ...
        child: Column(children: [
          Container(
            ...
            child: Row(children: [
              ...
              Text('(${orderModel.detailsCount} ${'item'.tr})',
                  style: robotoRegular.copyWith(
                      fontSize: Dimensions.fontSizeSmall,
              ...
              Container(
                padding: EdgeInsets.symmetric(
                    horizontal: Dimensions.paddingSizeExtraSmall, vertical: 3),
                decoration: BoxDecoration(
                  color: orderModel.orderStatus == 'pending'
                      ? ColorResources.blue.withValues(alpha: 0.1)
                      : (orderModel.orderStatus == 'accepted' ||
                              orderModel.orderStatus == 'confirmed' ||
                              orderModel.orderStatus == 'delivered')
                          ? ColorResources.green.withValues(alpha: 0.1)
                          : orderModel.orderStatus == 'canceled'
                              ? ColorResources.red.withValues(alpha: 0.1)
                              : Theme.of(context)
                                  .primaryColor
