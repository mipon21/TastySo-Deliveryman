...
class _LocationCardWidgetState extends State<LocationCardWidget> {
  ...
  Widget build(BuildContext context) {
    double restaurantDistance =
      ...
      LatLng(double.parse(widget.orderModel.restaurantLat!),
          double.parse(widget.orderModel.restaurantLng!)),
    );

    double restaurantToCustomerDistance =
        Get.find<AddressController>().getRestaurantDistance(
      LatLng(double.parse(widget.orderModel.restaurantLat!),
          double.parse(widget.orderModel.restaurantLng!)),
                                  ...
                                  children: [
                                    Row(children: [
                                      ...
                                      Container(
                                        ...
                                        child: Text(
                                          '${restaurantDistance > 1000 ? '1000+' : restaurantDistance.toStringAsFixed(2)} ${'km'.tr} ',
                                          maxLines: 1,
                                          overflow: TextOverflow.ellipsis,
                              ...
                              Row(children: [
                                ...
                                Container(
                                  ...
                                  padding: const EdgeInsets.all(
                                      Dimensions.paddingSizeExtraSmall),
                                  child: Text(
                                    '${restaurantToCustomerDistance > 1000 ? '1000+' : restaurantToCustomerDistance.toStringAsFixed(2)} ${'km'.tr}',
                                    maxLines: 1,
                                    overflow: TextOverflow.ellipsis,
                                    style: robotoBold.copyWith(
                                        fontSize: Dimensions.fontSizeSmall),
                          ...
                          onPressed: () {
                            showCustomBottomSheet(
                              child: CustomConfirmationBottomSheet(
                                ...
                                onConfirm: () {
                                  widget.orderController
                                      .acceptOrder(widget.orderModel.id,
                                          widget.index, widget.orderModel)
                                      .then((isSuccess) {
                                    if (isSuccess) {
                                      widget.onTap();
                                      widget.orderModel.orderStatus = (widget
                                      ...
                                      Get.toNamed(
                                        ...
                                        arguments: OrderDetailsScreen(
                                          ...
                                          isRunningOrder: true,
                                          orderIndex: widget.orderController
