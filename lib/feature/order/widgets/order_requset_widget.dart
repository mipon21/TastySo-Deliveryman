...
import 'package:tastyso_delivery_driver/feature/order/screens/order_location_screen.dart';
...
class OrderRequestWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    double distance = Get.find<AddressController>().getRestaurantDistance(
      LatLng(double.parse(orderModel.restaurantLat!),
          double.parse(orderModel.restaurantLng!)),
    );
