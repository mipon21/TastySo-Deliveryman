...
import 'package:tastyso_delivery_driver/feature/cash_in_hand/widgets/payment_method_bottom_sheet_widget.dart';
import 'package:tastyso_delivery_driver/feature/cash_in_hand/widgets/wallet_attention_alert_widget.dart';
                                                                          ...
                                                                          Expanded(
                                                                            child:
                                                                              ...
                                                                              child: Container(
                                                                                ...
                                                                                child: !cashInController.isLoading
                                                                                    ? Text(
                                                                                        'ok'.tr,
                                                  ...
                                                  if (Get.find<
                                                    ...
                                                    showCustomSnackBar(
                                                      ...
                                                      profileController
                                                          ...
                                                          .payableBalance!) {
                                                    showCustomSnackBar(
                                                        '${'you_do_not_have_sufficient_balance_to_pay_the_minimum_payable_balance_is'.tr} ${PriceConverter.convertPrice(Get.find<SplashController>().configModel!.minAmountToPayDm)}');
                                                  }
                                                }
                                              },
                                              child: Container(
